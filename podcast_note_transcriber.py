...
async def get_podcast_audio_transcription():
    ...
    for record in records:
        ...
        transcript = await transcribe_endpoint(audio_url, episode_name=record['fields'].get('Episode Title', ''))

        # Update the record with the transcript
        airtable_service.update_record("Podcast_Episodes", record_id, {'Transcription': transcript.get('transcript', ''), 'Downloaded': True})
