...
# Import test-specific AI usage tracker instead of production one
...
async def run_test(batch_size: int, concurrency: int, limit: Optional[int], output_file: str, model: str = "gemini_flash", test_name: str = "default_test") -> None:
    """
